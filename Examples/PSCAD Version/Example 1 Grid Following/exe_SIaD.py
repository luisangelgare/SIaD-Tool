...
workspace_name = 'VSC_Grid_Connected'   # PSCAD workspace name
project_name = "VSC_GFL_LAGR"       # PSCAD project name
fortran_ext = ".gf46"             # Fortran or intel version: ".gf46", ".gf81", etc.
out_filename = "dq_measurements"  # Proposed name of the file .out (must be assigned here)
results_folder = "Results_dq"     # Proposed name of the results folder

Tinit = 6                     # Initialization time (s)
fs = 1                         # Resolution frequency in Hz
f_max = 500                    # Upper limit of the frequency band
f_points = 200                 # Number of frequency points
