...
workspace_name = 'Your_Workspace_Name'   # PSCAD workspace name
project_name = "Your_Project_Name"       # PSCAD project name
fortran_ext = ".gf46"          # Fortran or intel version: ".gf46", ".gf81", etc.
out_filename = "measurements"  # Proposed name of the file .out (must be assigned here)
results_folder = "outcomes"    # Proposed name of the results folder

Tinit = 10                     # Initialization time (s)
fs = 1                         # Resolution frequency in Hz
f_max = 500                    # Upper limit of the frequency band
f_points = 100                 # Number of frequency points
